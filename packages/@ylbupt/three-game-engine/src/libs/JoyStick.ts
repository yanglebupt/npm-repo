  ...
  constructor(options) {
    ...
    if (options.left !== undefined) {
      circle.style.cssText =
        'position:absolute; bottom:35px; width:80px; height:80px; background:rgba(126, 126, 126, 0.5); border:#444 solid medium; border-radius:50%; left:20px;'
    } else if (options.right !== undefined) {
      circle.style.cssText =
        'position:absolute; bottom:35px; width:80px; height:80px; background:rgba(126, 126, 126, 0.5); border:#444 solid medium; border-radius:50%; right:20px;'
    } else {
      circle.style.cssText =
